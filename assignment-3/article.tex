...
\begin{align}
%% \mathfrak{R}_m(\mathcal{H}_{\max}) &= \mathbb{E}\left[\sup_{g\in\mathcal{H}{\max}}\frac{1}{m} \sum_{i=1}^m \sigma_i g(z_i)\right] \\
...
%% &\leq \mathbb{E} \left[ \sup_{h\in\mathcal{H}, h_0\in\mathcal{H}_0} \frac{1}{2m} \sum_{i=1}^m \sigma_i (h(z_i) + h_0(z_i)) + \frac{1}{2m} \sum_{i=1}^m \sigma_i |h(z_i) - h_0(z_i)| \right] \\
